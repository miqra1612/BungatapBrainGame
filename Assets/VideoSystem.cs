...
public class VideoSystem : MonoBehaviour
{
    ...
    private bool videoInit = true;
    public VideoSurface userView;
    public VideoSurface guessView;
    public GameObject waitToConnect;

    public List<VideoSurface> userConnected;
    ...
    public void BackToMainMenu()
    {
        if (mRtcEngine != null)
        {
            ...
            userConnected.Clear();
            IRtcEngine.Destroy();
            SceneController.instance.OpenScene("Home");
        }
    }
    ...
    public VideoSurface makeImageSurface(string goName)
    {
        ...
        */
        ...
        {
            videoSurface = userView;
            userConnected.Add(videoSurface);
        }
        else
        {
            videoSurface = guessView;
            userConnected.Add(videoSurface);
        }
